  ...
  return (
    <>
      ...
      <Link
        ...
        className="flex items-center text-2xl font-bold text-gray-600 hover:text-indigo-900 py-4 transition-all duration-300 hover:translate-x-1"
      >
          ...
          <div className="relative p-4 w-full max-w-4xl bg-gray-300 rounded-lg shadow-lg">
            ...
            <div className="flex items-center justify-between p-4 md:p-5 border-b border-gray-200 rounded-t">
              <h3 className="text-3xl font-bold text-gray-900 flex items-center">
                <img
                  className="h-20 w-auto rounded-lg mr-8"
                  src="/scientist.png"
                  alt="Logo"
                />
            ...
            <div className="p-4 md:p-5 space-y-4">
              <p className="text-xl leading-relaxed text-gray-600 font-bold">
            ...
            <div className="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b">
              <button
                onClick={() => setIsOpen(false)}
                className="text-white bg-blue-800 hover:bg-blue-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold rounded-lg text-xl px-5 py-2.5"
              >
                Close
              </button>
            </div>
