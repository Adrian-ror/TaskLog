...
const PriorityButton = ({ label, onClick, colorClass, icon }) => (
  <button
    onClick={onClick}
    className="flex text-md border-b-2 border-gray-300 font-bold items-center text-gray-600 hover:text-indigo-900 py-2 transition-all duration-300 hover:translate-x-1"
  >
    {colorClass ? (
