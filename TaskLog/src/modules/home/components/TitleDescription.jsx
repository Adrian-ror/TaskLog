...
const TitleDescription = () => {
  return (
    <div className="mr-8 place-self-center lg:col-span-7">
      <h1 className="max-w-4xl mb-10 text-5xl font-extrabold leading-none tracking-tight">
        Managing your tasks <br /> with grace.
      </h1>
      <p className="leading-relaxed text-gray-600 font-bold max-w-7xl mb-6 lg:mb-8 text-md">
